...
public typealias Indexx = Int
public typealias Closure = () -> Void
public typealias SelectionClosure = (Indexx, String) -> Void
public typealias MultiSelectionClosure = ([Indexx], [String]) -> Void
public typealias ConfigurationClosure = (Indexx, String) -> String
public typealias CellConfigurationClosure = (Indexx, String, DropDownCell) -> Void
...
public final class DropDown: UIView {
    ...
    */
    ...
    fileprivate var selectedRowIndices = Set<Indexx>()
...
extension DropDown {
    ...
    */
    ...
    public func selectRow(at index: Indexx?, scrollPosition: UITableView.ScrollPosition = .none) {
        if let index = index {
            tableView.selectRow(
    ...
    public func selectRows(at indices: Set<Indexx>?) {
        indices?.forEach {
            selectRow(at: $0)
        }
    ...
    public func deselectRow(at index: Indexx?) {
    ...
    public func deselectRows(at indices: Set<Indexx>?) {
        indices?.forEach {
            deselectRow(at: $0)
        }
    }
    ...
    public var indexForSelectedRow: Indexx? {
    ...
    @objc public func selectRow(_ index: Int, scrollPosition: UITableView.ScrollPosition = .none) {
        self.selectRow(at:Indexx(index), scrollPosition: scrollPosition)
    }
    ...
    @objc public func deselectRow(_ index: Int) {
        tableView.deselectRow(at: IndexPath(row: Indexx(index), section: 0), animated: true)
    }
